...
class AlipayPay extends Model {
	 ...
	 */
	public function tianjia($us_id, $ali_number, $ali_money, $ali_relevance, $ali_type) {
		$ali_note = buy_note($ali_type);
		$array = array(
			'us_id' => $us_id,
	...
	public function back_success($number) {
		...
		if ($rel) {
			model("PayRecord")->tianjia(2, $info['us_id'], $info['ali_money'], $info['ali_type'], $info['ali_note']);
		}
		return $rel;
	}
}
